// Хранилище не основе LevelDB
//
// Каждое хранилище может использовать уникальный префикс ключей, таким образом
// создавая виртуальное раделение внутри одной базы данных
package level
